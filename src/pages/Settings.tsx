                        ...
                        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 mb-6">
                            ...
                            <div className="flex items-center gap-2">
                                <button
                                    ...
                                    className="px-3 py-1 rounded-lg border border-border bg-surface-highlight text-sm font-semibold text-text-secondary hover:text-text-primary transition-colors"
                                >
                                    View Profile
                                </button>
                                <button
